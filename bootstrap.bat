...
vcpkg install --recurse boost-multi-array boost-signals2 catch2 glfw3 globjects stb imgui[glfw-binding,opengl3-binding] spdlog fp16 highfive[boost] ktx tinygltf tinyexr
cd ..
