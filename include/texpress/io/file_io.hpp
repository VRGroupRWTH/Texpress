...
namespace texpress {
    ...
    bool file_read(const char* path, char* buffer, uint64_t buffer_size, FileType type = FileType::FILE_BINARY);
    bool file_save(const char* path, char* buffer, uint64_t buffer_size, FileType type = FileType::FILE_BINARY);
